...
\item $\InvSoftPlus(\beta_{l}) \sim \Dist{Normal}(\gst(1/5),0.1)$
\item $\InvSoftPlus(\gamma) \sim \Dist{Normal}(\gst(1/5),0.1)$
\item $\InvSoftPlus(\sigma) \sim \Dist{Normal}(\gst(0.2),0.1)$
...
\item $\Evolve{s_l} = -\beta_{l} \cdot i_l \cdot s_l \cdot \frac{1}{N}$
\item $\Evolve{e_l} = \beta_{l} \cdot  i_l \cdot  s_l \cdot \frac{1}{N} - \sigma \cdot  e_l$
\item $\Evolve{i_l} = \sigma \cdot e_l - \gamma \cdot  i_l$
\item $\Evolve{r_l} = \gamma \cdot  i_l$
\item $\Observe = \Sigmoid( \delta ) \cdot i_l$ % deaths
\item $\Observe = r_l$ % for compatibility with two outcomes case  
\end{itemize}
