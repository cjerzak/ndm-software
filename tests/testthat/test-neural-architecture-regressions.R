...
ndm_test_architecture_env <- function(backbone = FALSE) {
  ...
  if (backbone) {
    list2env(list(
      ...
      ModelDepth = 2L, TransformerHeads = 2L, TransformerKVHeads = 1L,
      TransformerHeadDim = 8L, TransformerKVGroupSize = 2L,
      TransformerList = list(list(), list()), UseLatentAttention = FALSE,
